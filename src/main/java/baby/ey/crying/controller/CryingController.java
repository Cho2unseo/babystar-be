...
public class CryingController {
    ...
    public CryingResponseDto createCrying(@RequestBody CryingRequestsDto requestDto) throws IOException {
        String imageUrl = cryingService.uploadCrying(requestDto.getPath());
        return cryingService.createCrying(imageUrl);
    }
}
